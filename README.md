...
전처리 결과 데이터와 빈도분석 데이터를 **ChatGPT**에 입력하여 분석을 요청하고, ChatGPT의 제안을 바탕으로 불용어와 통합 사전을 반복적으로 추가·수정하는 방식으로 사전을 고도화했습니다.

테스트에 사용한 YouTube 영상은 다음 키워드로 검색한 영상들입니다:

- `AI`, `로봇`, `빈곤`, `은둔`, `이주배경 노동자`
...
- 한국어 불용어 목록 (spikeekips): https://gist.github.com/spikeekips/40eea22ef4a89f629abd87eed535ac6a
